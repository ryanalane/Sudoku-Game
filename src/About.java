...
public class About extends JPanel {
    ...
    // Creates aboutFrame instance and sets properties for aboutFrame
    // It also inserts this JPanel into the about frame
    ...
    public static void createAndShowGUI() {
        ...
        // Creates an instance of the panel, which is this class itself
        About panelInstance = new About();

        // Sets up the panel instance you just created as the contents of the JFrame
        // that was created in SudokuGame class
    ...
    // Closes aboutFrame when OK is clicked
